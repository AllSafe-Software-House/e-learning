<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item <?php echo e((request()->is(getAdminPanelUrl('/bonus_card*', false))) ? 'active' : ''); ?>">
                <a href="<?php echo e(getAdminPanelUrl()); ?>/bonus_card" class="nav-link">
                    <i class="fa fa-pager"></i>
                    <span><?php echo e(trans('update.Bonus_card')); ?></span>
                </a>
            </li>
...
<?php /**PATH /var/www/html/AllSafeProjects/new_course/courses_new/resources/views/admin/includes/sidebar.blade.php ENDPATH**/ ?>