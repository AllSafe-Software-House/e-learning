            ...
            <div class="mx-lg-30 d-none d-lg-flex flex-grow-1 navbar-toggle-content " id="navbarContent">
                ...
                <ul class="navbar-nav mr-auto d-flex align-items-center">
                    ...
                    <?php endif; ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('bonusCard')); ?>">bonus card</a>
                            </li>
                </ul>
            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/AllSafeProjects/new_course/courses_new/resources/views/web/default/includes/navbar.blade.php ENDPATH**/ ?>