                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-6 mt-20 mt-lg-0">
                        <div class="position-relative ">
                            ...
                            <img src="<?php echo e(asset('assets/default/img/home/circle-4.png')); ?>" class="find-instructor-section-circle" alt="circle">
                            <img src="<?php echo e(asset('assets/default/img/home/dot.png')); ?>" class="find-instructor-section-dots" alt="dots">
                            ...
                            <div class="example-instructor-card bg-white rounded-sm shadow-lg  p-5 p-md-15 d-flex align-items-center">
                                <div class="example-instructor-card-avatar">
                                    <img src="<?php echo e(asset('assets/default/img/home/toutor_finder.svg')); ?>" class="img-cover rounded-circle" alt="user name">
                                </div>
                        ...
                        <div class="position-relative reward-program-section-hero-card">
                            ...
                            <div class="example-reward-card bg-white rounded-sm shadow-lg p-5 p-md-15 d-flex align-items-center">
                                <div class="example-reward-card-medal">
                                    <img src="<?php echo e(asset('assets/default/img/rewards/medal.png')); ?>" class="img-cover rounded-circle" alt="medal">
                                </div>
                    ...
                    <div class="col-12 col-lg-6 mt-20 mt-lg-0">
                        <div class="position-relative ">
                            ...
                            <div class="example-instructor-card bg-white rounded-sm shadow-lg border p-5 p-md-15 d-flex align-items-center">
                                <div class="example-instructor-card-avatar">
                                    <img src="<?php echo e(asset('assets/default/img/home/become_instructor.svg')); ?>" class="img-cover rounded-circle" alt="user name">
                                </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/AllSafeProjects/new_course/courses_new/resources/views/web/default/pages/home.blade.php ENDPATH**/ ?>