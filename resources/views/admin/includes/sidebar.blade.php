<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item {{ (request()->is(getAdminPanelUrl('/bonus_card*', false))) ? 'active' : '' }}">
                <a href="{{ getAdminPanelUrl() }}/bonus_card" class="nav-link">
                    <i class="fa fa-pager"></i>
                    <span>{{ trans('update.Bonus_card') }}</span>
                </a>
            </li>
